            ...
            <div className="container">
                ...
                <div className="auth-page py-3">
                    <div className="text-center mt-3 mb-5">
                        ...
                        <p>Select the option that best describes you and log in to the platform</p>
                    </div>
                            ...
                            <div className="authPage-Card py-3 px-2 mt-2">
                                <div>
                                    ...
                                    <div className="d-flex justify-content-between flex-column w-50 m-auto">
                                        <button type="button" className="btn btn-outlined" onClick={() => { navigate("/auth/login") }}>Log In</button>
                                        <button type="button" className="btn btn-border mt-2" onClick={() => { navigate("/auth/sign-up") }}>Sign Up</button>
                        ...
                        <div className="col-sm-6 col-md-5 col-lg-5">
                            <div className="authPage-Card py-3 px-2 mt-2">
                                <div>
                                    ...
                                    <p>The best hospitals love us as we offer premium benefits.</p>
                                    <div className="d-flex justify-content-between flex-column w-50 m-auto">
                                        <button type="button" className="btn btn-outlined">Log In</button>
                                        <button type="button" className="btn btn-border mt-2">Sign Up</button>
                                    </div>
                                </div>
                            </div>
                        </div>
